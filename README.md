...
- In settings.json, paste the game ID in whitelist with any game ID you DON'T want to be unfavorited. If you want all games removed, do nothing. You can always add more IDs, separated by commas.
